  ...
  return (
    <div className={cx("Preparation")}>
      ...
      <div id="content">
        ...
        />
        {!checkItemsOK ? <CheckItems setCheckItemsOK={setCheckItemsOK} />
         : !micTestOK ? <MicTest setMicTestOK={setMicTestOK} />
         : !camTestOK ? <CamTest setCamTestOK={setCamTestOK} />
         : !PPTUploadOK ? <PPTUpload setPPTUploadOK={setPPTUploadOK} />
