...
const Service = () => {
    ...
    return (
      <div className={cx("Service")}>
        { !preparationOK? <Preparation setPreparationOK={setPreparationOK} />:
          !recodingOK? <Recoding setRecodingOK={setRecodingOK} />:
          !resultOK? <Result setResultOK={setResultOK}/>: <>모두완료!</>
        }
      </div>
    )
}
