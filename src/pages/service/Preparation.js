...
import CompletePreparation from "components/service/CompletePreparation.js";
    ...
    <div className={cx("Preparation")}>
      ...
      <div id="content">
        <PreparationNavbar
          isMicTest={isMicTest}
          isCamTest={isCamTest}
          isPPTUpload={isPPTUpload}
        />
        {!isCheckItems ? (
          <CheckItems setIsCheckItems={setIsCheckItems} />
        ) : !isMicTest ? (
          <MicTest setIsMicTest={setIsMicTest} />
        ) : !isCamTest ? (
          <CamTest setIsCamTest={setIsCamTest} />
        ) : !isPPTUpload ? (
          <PPTUpload setIsPPTUpload={setIsPPTUpload} />
        ) : (
          <CompletePreparation />
        )}
      </div>
